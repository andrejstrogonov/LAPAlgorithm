...
def relax_algorithm(sequences, min_support, min_confidence, relaxation_factor):
    ...
    while current_itemsets:
        ...
        freq_itemsets.update({itemset: count for itemset, count in current_itemsets.items() if count >= min_support * relaxation_factor})
        k += 1
...
freq_itemsets, rules = relax_algorithm(sequences, min_support, min_confidence, relaxation_factor)
